              ...
              <input type="hidden" name="roles" value="1">   
                ...
                <div class="mb-3 form-password-toggle">
                  ...
                  <div class="input-group input-group-merge">
                    <input type="text" class="form-control form-control" id="password" name="password" placeholder="Password">
                ...
                <div class="mb-3 form-password-toggle">
                    ...
                    <input type="text" class="form-control form-control" id="confirm_password" name="confirm_password" placeholder="Confirm Password">                    
                    <?php if(isset($validation)):?>
