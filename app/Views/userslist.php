  ...
  <body>
    ...
    <script>
                                ...
                                <tr data-id="${post.id_user}">
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu">
                                            ...
                                            <a class="dropdown-item" href="<?= base_url('updatestatusUser/') ?>${post.id_user}"
        ...
        $('tr').on('click', function() {
            var ids = $(this).data('id_user');
            $.ajax({
                url: '<?= base_url('updatestatusUser/') ?> + ids',
                type: 'POST',
                success: function(response) {
                    // Tindakan setelah permintaan berjaya
                },
                error: function(jqXHR, textStatus, errorThrown) {
                    // Tindakan setelah terjadi kesalahan
                }
            });
        });
