            ...
            <div class="navbar-nav-right d-flex align-items-center" id="navbar-collapse">
              ...
              <ul class="navbar-nav flex-row align-items-center ms-auto">
                ...
                <li class="nav-item lh-1 me-3">
                  <a><h4 style="margin-top: 10px;"><b><?= session('username');?></b></h4> </a>                  
                </li>
                    ...
                    <div class="d-flex align-items-end row">
                      ...
                      <div class="col-sm-5 text-center text-sm-left">
                        <div class="card-body pb-0 px-0 px-md-4">
                          <img
                            src="<?= base_url('mywebs/admins/assets/img/illustrations/man-with-laptop-light.png') ?>"
                            height="140"
                            alt="View Badge User"
                        ...
                        <div class="card-body">
                          <div class="card-title d-flex align-items-start justify-content-between">
                            <div class="avatar flex-shrink-0">
                              <img
                                src="<?= base_url('mywebs/admins/assets/img/icons/unicons/chart-success.png') ?>"
                                alt="chart success"
                                class="rounded"
                              />
                            </div>
                      ...
                      <div class="card">
                        <div class="card-body">
                          <div class="card-title d-flex align-items-start justify-content-between">
                            <div class="avatar flex-shrink-0">
                              <img
                                src="<?= base_url('mywebs/admins/assets/img/icons/unicons/wallet-info.png') ?>"
                                alt="Credit Card"
                                class="rounded"
                              />
                            </div>
                    ...
                    <div class="col-6 mb-4">
                      <div class="card">
                        <div class="card-body">
                          <div class="card-title d-flex align-items-start justify-content-between">
                            <div class="avatar flex-shrink-0">
                              <img src="<?= base_url('mywebs/admins/assets/img/icons/unicons/paypal.png') ?>" alt="Credit Card" class="rounded" />
                            </div>
                            <div class="dropdown">
                              <button
                                class="btn p-0"
                    ...
                    <div class="col-6 mb-4">
                      <div class="card">
                        <div class="card-body">
                          <div class="card-title d-flex align-items-start justify-content-between">
                            <div class="avatar flex-shrink-0">
                              <img src="<?= base_url('mywebs/admins/assets/img/icons/unicons/cc-primary.png') ?>"  alt="Credit Card" class="rounded'/>
                            </div>
                            <div class="dropdown">
                              <button
                                class="btn p-0"
                      ...
                      <div class="tab-content p-0">
                        <div class="tab-pane fade show active" id="navs-tabs-line-card-income" role="tabpanel">
                          <div class="d-flex p-4 pt-3">
                            <div class="avatar flex-shrink-0 me-3">
                              <img src="<?= base_url('mywebs/admins/assets/img/icons/unicons/wallet.png') ?>"/>
                            </div>
                            <div>
                  ...
                  <div class="card h-100">
                    ...
                    <div class="card-body">
                      <ul class="p-0 m-0">
                        <li class="d-flex mb-4 pb-1">
                          <div class="avatar flex-shrink-0 me-3">
                            <img src="<?= base_url('mywebs/admins/assets/img/icons/unicons/paypal.png') ?>" alt="User" class="rounded" />
                          </div>
                          <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                            <div class="me-2">
                        ...
                        <li class="d-flex mb-4 pb-1">
                          <div class="avatar flex-shrink-0 me-3">
                            <img src="<?= base_url('mywebs/admins/assets/img/icons/unicons/wallet.png') ?>" alt="User" class="rounded" />
                          </div>
                          <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                            <div class="me-2">
                        ...
                        <li class="d-flex mb-4 pb-1">
                          <div class="avatar flex-shrink-0 me-3">
                            <img src="<?= base_url('mywebs/admins/assets/img/icons/unicons/chart.png') ?>" alt="User" class="rounded" />
                          </div>
                          <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                            <div class="me-2">
                        ...
                        <li class="d-flex mb-4 pb-1">
                          <div class="avatar flex-shrink-0 me-3">
                            <img src="<?= base_url('mywebs/admins/assets/img/icons/unicons/cc-success.png') ?> alt="User" class="rounded"" />
                          </div>
                          <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                            <div class="me-2">
                        ...
                        <li class="d-flex">
                          <div class="avatar flex-shrink-0 me-3">
                            <img src="<?= base_url('mywebs/admins/assets/img/icons/unicons/cc-warning.png') ?>" alt="User" class="rounded" />
                          </div>
                          <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                            <div class="me-2">
